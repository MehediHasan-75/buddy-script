      ...
      <div className="_layout_right_sidebar_inner">
        <div className="_feed_right_inner_area_card _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          ...
          <div className="_feed_bottom_fixed">
            {[
              { name: 'Steve Jobs',      role: 'CEO of Apple',   img: 'people1.png', active: false },
              { name: 'Ryan Roslansky', role: 'CEO of Linkedin', img: 'people2.png', active: true  },
              { name: 'Dylan Field',    role: 'CEO of Figma',    img: 'people3.png', active: true  },
              { name: 'Steve Jobs',      role: 'CEO of Apple',   img: 'people1.png', active: false },
              { name: 'Ryan Roslansky', role: 'CEO of Linkedin', img: 'people2.png', active: true  },
              { name: 'Dylan Field',    role: 'CEO of Figma',    img: 'people3.png', active: true  },
              { name: 'Dylan Field',    role: 'CEO of Figma',    img: 'people3.png', active: true  },
              ...
              <div
                key={i}
                className={`_feed_right_inner_area_card_ppl${p.active ? '' : ' _feed_right_inner_area_card_ppl_inactive'}`}
              >
                <div className="_feed_right_inner_area_card_ppl_box">
                  <div className="_feed_right_inner_area_card_ppl_image">
                    <a href="profile.html">
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img src={`/assets/images/${p.img}`} alt={p.name} className="_box_ppl_img" />
                    </a>
                  </div>
                  <div className="_feed_right_inner_area_card_ppl_txt">
                    <a href="profile.html">
                      <h4 className="_feed_right_inner_area_card_ppl_title">{p.name}</h4>
                    </a>
                    <p className="_feed_right_inner_area_card_ppl_para">{p.role}</p>
                  </div>
                </div>

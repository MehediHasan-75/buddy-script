...
export function Navbar({ currentUser }: NavbarProps) {
  ...
  const handleLogout = () => {
    clearToken();
    document.cookie = 'bs_session=; path=/; max-age=0';
    router.push('/login');
  };
    ...
    <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
      <div className="container _custom_container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          {/* Profile dropdown */}
          <div className="_header_profile" style={{ position: 'relative' }}>
            <button
            ...
            >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="12" height="7" fill="none" viewBox="0 0 12 7">
                <path stroke="#000" strokeOpacity=".6" strokeLinecap="round" strokeLinejoin="round" d="M1 1l5 5 5-5" />
              </svg>
            </button>
              ...
              <div id="_prfoile_drop" className="_nav_profile_dropdown _profile_dropdown show">
                <div className="_nav_profile_dropdown_info">
                  ...
                  <div className="_nav_profile_dropdown_info_txt">
                    <h4 className="_nav_dropdown_title">{currentUser.firstName} {currentUser.lastName}</h4>
                ...
                <ul className="_nav_dropdown_list">
                  ...
                  <li className="_nav_dropdown_list_item">
                    <a href="#" className="_nav_dropdown_link" onClick={e => { e.preventDefault(); handleLogout(); }}>
                      <div className="_nav_drop_info">
                        <span>
